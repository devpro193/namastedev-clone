        ...
        >
          ...
          <section className="flex max-md:flex-col flex-[2] lg:justify-around font-semibold lg:p-5 py-5 w-full max-lg:gap-8">
            <div className="flex text-sm gap-4 flex-col max-w-64">
              ...
              <span>MERN FullStack Stack</span>
              <span>DSA Live Placement Course</span>
              <span>Live FullStack Web Development MERN & NEXT</span>
            </div>
            <div className="flex text-sm gap-4 flex-col max-w-64">
              <span className="text-muted-foreground uppercase">Resourse</span>
