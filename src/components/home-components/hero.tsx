  ...
  return (
    <div className="w-full grid bg-[url('/main/hero_section_fullstack.png')] min-h-96 bg-repeat-x">
      <div className="tab:p-[11.5rem_5.5rem_5.75rem] max-tab:pt-[5rem] max-tab:pb-[4.5rem] m-auto max-w-4xl grid gap-7 place-items-center phone:text-center text-white">
        <h1
          className={`font-jakarta phone:text-[3.5rem] text-[2.5rem] font-extrabold bg-gradient-to-r from-rose-300 to-yellow-400 text-transparent bg-clip-text leading-tight px-2 max-phone:px-6`}
        >
        ...
        <div className="p-[.5rem_1.75rem_.5rem_1.00rem] rounded-[3.125rem] flex items-center gap-2 w-fit my-2 mb-1 bg-gradient-to-r from-[rgba(28,_113,_173,_.7)] to-[rgba(28,_113,_173,_.2)]">
