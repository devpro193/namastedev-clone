    ...
    <>
      <div className={`flex justify-between items-start py-5 bg-zinc-950`}>
        <section className="grid gap-2 text-gray-400/70 font-semibold p-5">
          <Image src={"/name.webp"} alt="name" width={200} height={200} />
          <span className="hover:text-gray-400">Privacy Policy</span>
          <span className="hover:text-gray-400">Terms Of Service</span>
          <span className="hover:text-gray-400">Refund Policy</span>
          <span className="hover:text-gray-400">Gift a Course</span>
          <span className="hover:text-gray-400">Team</span>
