...
function ProfileCard({
  ...
  return (
    <Reveal>
      <div
        className={`relative flex flex-col bg-second rounded-md shadow-inner transition-all duration-500 w-full items-start gap-7 border pb-6`}
      >
  ...
  let mentors: Profile[] = [
    {
      ...
      description:
        "Our lead mentor Aryan Singh, a visionary software engineer at Google, leading 30 Days Coding. With roles in tech giants and projects like Blocktrain and DSA Revision, Aryan combines professional expertise with a passion for mentoring.",
      company: [
